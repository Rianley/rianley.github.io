...
### 实验文件列表
先介绍一下文件列表：
![code-directory](/_posts/images/code-directory.jpg)
...
![do not use jsonp url](/_posts/images/do-not-use-jsonp-url.png)
然后查看一下报错信息：
![do not use jsonp error infomation](/_posts/images/do-not-use-jsonp.png)
...
![jsonp请求](/_posts/images/jsonp-request-method-1.jpg)
查看控制台输出：
![控制台输出](/_posts/images/jsonp-cosole-output.jpg)
而查看服务端日志，如下：
![服务端日志](/_posts/images/service-jsonp-method-log.jpg)
...
![预检](/_posts/images/put-request.jpg)
...
![预检](/_posts/images/put-request.jpg)
![PUT请求](/_posts/images/put-request2.jpg)